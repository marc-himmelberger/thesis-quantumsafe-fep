...
In this thesis, we build on the Tor Project's lyrebird repository, which implements the obfuscation protocol \obfsfour{} \cite{obfs4}. We adapt this implementation to include the obfuscated key exchange protocol \drivel{} \cite{EPRINT:GRSV25}, which extends the \obfsfour{} protocol with post-quantum security and stronger obfuscation.
