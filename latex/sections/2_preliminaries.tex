...
\label{lem:ctxt-unif-for-bijections}
    ...
    Let $\mathbf{C}' \subseteq \mathbf{C}$ denote the subset of the ciphertext space of $\KEM$ where $\encodectxt$ does not output $\bot$, i.e. the set of encodable ciphertexts.
