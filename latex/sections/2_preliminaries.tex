...
Throughout this thesis, we employ the quantum random oracle model (QROM) where applicable. For the definition of pseudorandom functions (PRF), message authentication codes (MAC), authenticated encryption (AE), symmetric encryption (SE), as well as the notion of PRF security, we refer readers to the excellent introductory textbook \cite{katz_lindell}.
