...
\procedure[lnstart=5,linenumbering]{$\encaps(\pk=(\mathbf h, \mathbf s))$ \titlecomment{\text{see \cite[Figure~3]{NISTPQC-R4:HQC22}}}}{
    ...
    \theta \gets \mathcal G(\mathbf m \mathbin\Vert \textsf{firstBytes}(\pk,32) \mathbin\Vert \mathit{salt}) \\
    ...
    \mathbf v \gets \textsf{truncate}(\mathbf m \mathbf G + \mathbf s \cdot \mathbf r_2 + \mathbf e, \ell) \\
